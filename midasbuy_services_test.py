...
print(midasbuy_services.midas_id_verifier(driver, driver.window_handles[0], 547, 1, "ot"))
print(midasbuy_services.midas_bundle_and_payment_method_chooser(driver, driver.window_handles[0], 600, 0,"Razer Gold", "ot"))
